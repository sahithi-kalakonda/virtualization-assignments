...
3. created cmpe283-1.c file using vi cmpe283-1.c command(code uploaded)
...
4. Checked whether the `Makefile` is uploaded using the command
...
5. Installed all the required libraries. Ensure you have the necessary dependencies installed.
...
6. Built the file using the Make command:
